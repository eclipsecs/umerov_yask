...
export const articles: Article[] = [
  {
    ...
    excerpt: 'I dont mean all teachers, but most of them',
...
## How SamSIFL is reshaping the student's brain to its worst

This is going to be a long story to read. And if you'd want to enroll here, I'd suggest you to think twice.
`
  },
  {
    id: '8',
